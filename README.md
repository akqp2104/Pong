...
- Customizable game rules:
  ...
  - Set the **maximum rounds to play**.
- The winner is the first player to win more than half the max rounds (e.g., with max rounds set to 5, first to win 3 rounds is the victor).
- Gameplay modes:
  - Two players mode.
  - Player vs AI
...
- *Menu & UI Controls:** All menu and in-game UI are navigated with the mouse
